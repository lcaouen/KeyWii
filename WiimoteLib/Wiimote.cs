...
namespace WiimoteLib
{
	...
	public class Wiimote : IDisposable
	{
        ...
        /// <summary>
        /// Connect to all wiimote available
        /// </summary>
        public static void GetConnectedWiimotes(List<Wiimote> in_lstMotes)
        {
            int index = 0;
            bool found = false;
            Guid guid;
            ...
            while (HIDImports.SetupDiEnumDeviceInterfaces(hDevInfo, IntPtr.Zero, ref guid, index, ref diData))
            {
                ...
                else
                {
                    ...
                    Debug.WriteLine("SetupDiGetDeviceInterfaceDetail failed on index " + index);
                }
            ...
            if (!found)
                Debug.WriteLine("Wiimote not found in HID device list.");
		...
		private void InitializeExtension()
		{
            ...
            else if (buff[0] == (byte)ExtensionType.Nunchuk && buff[1] == (byte)ExtensionType.Nunchuk)
...
//					mWiimoteState.ClassicControllerState.AccelCalibrationInfo.MaxTriggerR = (byte)(buff[15] >> 3);
		...
		public byte[] ReadData(int address, short size)
		{
            ...
            if (!mReadDone.WaitOne(1000, false)) return null;
